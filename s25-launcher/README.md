...
(Claude PC / كروم / سطح المكتب) يمكن سحب أي منها ليصبح أيقونة مستقلة على الشاشة
الرئيسية — أي أيقونة مباشرة لـ Claude PC.
...
الحزمة موقّعة بمفتاح **debug** — كافٍ تماماً للتثبيت اليدوي، وغير مناسب للنشر
في متجر Play. للتحقق من الحزمة الجاهزة:

```bash
sha256sum prebuilt/S25-Desktop-launcher.apk
# 132b0d9acb73707ec858fb919319b1504f2e183addf38f52bfbb14ff2b61c454
```
