...
تطبيق أندرويد صغير (~33 كيلوبايت، بدون أي مكتبات خارجية) يضع أيقونة على الشاشة
...
زر **«⟳ تحديث النظام»** ينفّذ `s25-update`: يسحب أحدث كود من المستودع *ويحدّث
نسخة السكربتات داخل الحاوية* — وهي خطوة لا يقوم بها `git pull` وحده، فبدونها
تظل الحاوية تشغّل سكربتات قديمة. استخدمه بعد كل إصلاح جديد.
...
# a5a582215e6aedec2642517755d0b9746de8f99ec3f5dcf27264fe8217ef1f2c
```
